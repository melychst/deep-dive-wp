<section class="columns-duble revers">
    <?php
        ...
        if( !empty($left_column) ):
            ...
            $bg_image = $left_column['background_image'];
            $bg_color = $left_column['background_color'];
    ...
    ?>
    <div class="column column-left column-left-title" style="<?php echo $background; ?>">
        <div class="content-wrap">
            <h1><?php echo  $left_column['title']; ?></h1>
            <?php 
                if( isset($left_column['image']) ):
            ?>
    ...
    <?php 
        ...
        if( !empty($right_column) ):
            $background = isset($right_column['background_color']) ? "background-color:". $right_column['background_color'] : '';
            $working_days = $right_column['working_days'];
        endif;
    ?>   
    <div class="column column-right column-right-contacts" style="<?php echo $background; ?>">
        <div class="content-wrap">
            <div class="top-row">
                <div class="contacts">
